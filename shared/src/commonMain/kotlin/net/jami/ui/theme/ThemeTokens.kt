...
data class JamiSizes(
    ...
    val presenceDotSmall: Dp = 8.dp,
    val presenceDotMedium: Dp = 12.dp,
    val presenceDotLarge: Dp = 14.dp,
    val presenceDotXLarge: Dp = 18.dp,
    val badgeMinSize: Dp = 20.dp,
    ...
    val messageInputMinHeight: Dp = 40.dp,
    val messageInputMaxHeight: Dp = 120.dp,
