...
/**
 * macOS system address-book integration (Contacts framework) is not implemented yet — this is
 * a stub, not a completed port. Tracked as a follow-up; see gap-analysis-2026-08.md.
 */
