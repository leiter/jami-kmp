 ...
 *
 * Uses UserNotifications framework (UNUserNotificationCenter) for desktop notifications.
 * Similar to iOS but optimized for desktop experience.
 *
 * ## Note
...
class MacOSNotificationService : NotificationService {
    ...
    override val serviceNotification: Any
        get() = Unit // macOS doesn't have foreground service notifications

    override fun onConnectionUpdate(connected: Boolean) {
        // macOS doesn't need a persistent service notification
        // Could update menu bar icon if implemented
    ...
    companion object {
        private const val TAG = "MacOSNotificationService"
