...
public class JamiService {
  ...
  public static void setAccountActive(String accountId, boolean active, boolean shutdownConnections) {
    JamiServiceJNI.setAccountActive__SWIG_0(accountId, active, shutdownConnections);
  }

  public static void setAccountActive(String accountId, boolean active) {
    JamiServiceJNI.setAccountActive__SWIG_1(accountId, active);
  }
  ...
  public static void updateProfile(String accountId, String displayName, String avatar, String fileType, String botOwner, int flag) {
    JamiServiceJNI.updateProfile(accountId, displayName, avatar, fileType, botOwner, flag);
  }
  ...
  public static String addExposedService(String accountId, StringMap details) {
    return JamiServiceJNI.addExposedService(accountId, StringMap.getCPtr(details), details);
  }

  public static boolean updateExposedService(String accountId, StringMap details) {
    return JamiServiceJNI.updateExposedService(accountId, StringMap.getCPtr(details), details);
  }

  public static boolean removeExposedService(String accountId, String serviceId) {
    return JamiServiceJNI.removeExposedService(accountId, serviceId);
  }

  public static VectMap getExposedServices(String accountId) {
    return new VectMap(JamiServiceJNI.getExposedServices(accountId), true);
  }

  public static long queryPeerServices(String accountId, String peerUri) {
    return JamiServiceJNI.queryPeerServices(accountId, peerUri);
  }

  public static String openServiceTunnel(String accountId, String peerUri, String deviceId, String serviceId, String serviceName, int localPort) {
    return JamiServiceJNI.openServiceTunnel(accountId, peerUri, deviceId, serviceId, serviceName, localPort);
  }

  public static boolean closeServiceTunnel(String accountId, String tunnelId) {
    return JamiServiceJNI.closeServiceTunnel(accountId, tunnelId);
  }

  public static VectMap getActiveTunnels(String accountId) {
    return new VectMap(JamiServiceJNI.getActiveTunnels(accountId), true);
  }

  public static void init(ConfigurationCallback confM, Callback callM, PresenceCallback presM, DataTransferCallback dataM, VideoCallback videoM, ConversationCallback convM, NetworkServiceCallback nsMgr) {
    JamiServiceJNI.init(ConfigurationCallback.getCPtr(confM), confM, Callback.getCPtr(callM), callM, PresenceCallback.getCPtr(presM), presM, DataTransferCallback.getCPtr(dataM), dataM, VideoCallback.getCPtr(videoM), videoM, ConversationCallback.getCPtr(convM), convM, NetworkServiceCallback.getCPtr(nsMgr), nsMgr);
  }
