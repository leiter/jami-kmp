...
class AppDelegate: NSObject, UIApplicationDelegate {
    ...
    func application(
        ...
        // 6. Install the Kotlin notification delegate (IOSNotificationDelegate). It presents
        // banners in the foreground and dispatches the Answer / Decline / Reply / Mark-read /
        // Accept / Decline-request action buttons. It replaces the Swift NotificationDelegate,
        // which silently dropped every action and has been removed. Must run after
